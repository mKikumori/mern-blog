...
app.use(cors({credentials: true, origin: ["https://mern-blog-frontend-red.vercel.app", "https://mern-blog-api-orpin.vercel.app/api/users/65d93031e7d1adb03dded966"], methods: ["POST", "GET"]}))
app.use(upload())
